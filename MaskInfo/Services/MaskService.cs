...
namespace MaskInfo.Services
{
    public class MaskService
    {
        ...
        public async Task<IEnumerable<Models.MaskInfo>> GetMaskInfo()
        {
            ...
            return await JsonSerializer.DeserializeAsync<IEnumerable<Models.MaskInfo>>(responseStream);
        }
    }
}
